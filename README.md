...
- **⟁** **[Wittgenstein-CLI](https://github.com/Moapacha/wittgenstein)** — A modality harness for text-first LLMs, traceable end-to-end. 
- **⧉** **[effectorHQ](https://github.com/effectorHQ)** — AI capabilities are in the pre-TypeScript era. Effector adds a typed interface layer—tools can be compiled, verified, and composed across runtimes. All in one `effector.toml` sidecar. 
